...
const MyExpenses = () => {
    ...
    // useEffect(() => {
    //     fetch(`https://nbcaccounts.clearsoftwares.xyz/ownerexpenses?category=${owner}`)
    //         .then(res => res.json())
    //         .then(data => {
    //             setMyExpenses(data)
    //         })
    ...
    // useEffect(() => {
    //     fetch(`https://nbcaccounts.clearsoftwares.xyz/myexpenses?category=${category}&subcategory=${subCategory}`)
    //         .then(res => res.json())
    //         .then(data => {
    //             setMyExpenses(data)
    //         })
