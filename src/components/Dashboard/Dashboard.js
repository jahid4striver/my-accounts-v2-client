        ...
        <div class="drawer drawer-mobile">
            ...
            <div class="drawer-side bg-red-200">
                ...
                <ul class="menu p-4 overflow-y-auto w-80 text-base-content mt-px bg-red-200 h-max">
                    ...
                    <li className=' bg-blue-400 peer-checked:bg-red-400 peer-checked:text-secondary-content mb-2'><Link to='/adddeposit'><img className='h-8' src="https://www.svgrepo.com/show/32881/cash.svg" alt="" />Add Bank Deposit</Link></li>
                    ...
                    <div class="collapse mb-2">
                        ...
                        <div class="collapse-title bg-red-300 peer-checked:bg-red-400 peer-checked:text-secondary-content flex justify-between">
                            <img className='h-6' src="https://www.svgrepo.com/show/93814/information.svg" alt="" />Add Informations <span><img className='h-8' src="https://www.svgrepo.com/show/368230/arrow-down.svg" alt="" /></span>
                        </div>
                        <div class="collapse-content">
                            <li className='mt-2'><Link to='/addcategories'><img className='h-8' src='https://www.svgrepo.com/show/356425/category.svg' alt="" /> Add Categories</Link></li>
                            <li><Link to='/addsubcategories'><img className='h-8' src='https://www.svgrepo.com/show/356425/category.svg' alt="" />Add Sub-Categories</Link></li>
                            ...
                            <li><Link to='/addprofits'><img className='h-6' src="https://www.svgrepo.com/show/4765/bank-sign.svg" alt="" /> Add Profit Accounts</Link></li>
                            <li><Link to='/addloangiven'><img className='h-8' src="https://www.svgrepo.com/show/163357/loan.svg" alt="" /> Add Loan Accounts</Link></li>
                            <li><Link to='/addloantaken'><img className='h-8' src="https://www.svgrepo.com/show/163357/loan.svg" alt="" /> Add Loan Taken Accounts</Link></li>
                    ...
                    <div class="collapse">
                        ...
                        <div class="collapse-title bg-red-300 peer-checked:bg-red-400 peer-checked:text-secondary-content flex justify-left">
                            <img className='h-6 mr-2' src="https://www.svgrepo.com/show/335473/reports.svg" alt="" />Reports <span><img className='h-8' src="https://www.svgrepo.com/show/368230/arrow-down.svg" alt="" /></span>
                        </div>
                        <div class="collapse-content">
                            ...
                            <li><Link to='/categorywisebalance'><img className='h-8' src='https://www.svgrepo.com/show/356425/category.svg' alt="" />CategoryWise Balance</Link></li>
                            ...
                            <li className='mt-2'><Link to='/allcash'><img className='h-8' src='https://www.svgrepo.com/show/32881/cash.svg' alt="" /> All Cash</Link></li>
                            ...
                            <li><Link to='/loanbalance'><img className='h-8' src='https://www.svgrepo.com/show/356425/category.svg' alt="" />Loan Balance Sheet</Link></li>
