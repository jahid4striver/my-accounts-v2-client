...
const CashStatement = () => {
    ...
    const handleFilteredData = e => {
        ...
        const url = `https://infinite-anchorage-69144.herokuapp.com/onlyexpense?startDate=${startDate}&endDate=${endDate}`
        fetch(url)
            .then(res => res.json())
            .then(data => {
                console.log(data);
        ...
        const url2 = `https://infinite-anchorage-69144.herokuapp.com/onlyincome?startDate=${startDate}&endDate=${endDate}`
