...
const IncomeExpense = () => {
    ...
    const handleFilteredData = e => {
        ...
        const url = `https://my-accounts.onrender.com/categorywiseexpense?category=${category}&subcategory=${subcategory}`
        ...
        const url2 = `https://my-accounts.onrender.com/incomeamount?chequecategory=${category}&chequesubcategory=${subcategory}`
