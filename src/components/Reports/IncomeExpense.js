...
const IncomeExpense = () => {
    ...
    const handleFilteredData = e => {
        ...
        const url = `https://nbcaccounts.clearsoftwares.xyz/categorywiseexpense?category=${category}&subcategory=${subcategory}`
        ...
        const url2 = `https://nbcaccounts.clearsoftwares.xyz/incomeamount?chequecategory=${category}&chequesubcategory=${subcategory}`
